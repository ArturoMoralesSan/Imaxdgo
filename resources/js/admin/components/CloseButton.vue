    ...
    data() {
        return {
            defaults: {
                ...
                localization : {
                    es : {
                        title             : 'Hacer cierre de día',
                        text              : 'Esta acción permitirá hacer un corte diario.',
                    ...
                    en : {
                        title             : 'Perform daily closing',
                        text              : 'This action will generate the daily closing.',
                        cancelButtonText  : 'Cancel',
                        confirmText       : 'Yes, approve',
                        errorText         : 'Message received:',
                        errorTitle        : 'The request could not be approved.',
                        successText       : 'The request was successfully approved.',
