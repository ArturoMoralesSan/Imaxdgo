      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
          <tr style="vertical-align:top;">
            <td style="background:#dfdfdf;background-position:center center;background-repeat:no-repeat;padding:15px 0 0;vertical-align:top;height:125px;" height="125">
                    ...
                    <tr>
                      <td style>
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;margin:0px;">
                          <tbody>
                            <tr>
                              <td align="center" style="font-size:0px;padding:10px 25px;padding-top:25px;padding-bottom:0;word-break:break-word;">
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:sans-serif;font-size:20px;font-weight:bold;line-height:23px;text-align:center;color:#6f7d8a;">Cierre diario</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:sans-serif;font-size:15px;line-height:23px;text-align:left;color:#6f7d8a;">
                          <p style="margin-bottom: 1.6em;"> Se ha completado el cierre diario de todas las sucursales en Durango.<br> Se adjunta el PDF con el desglose por sucursal y el monto de efectivo a recoger. </p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:30px;word-break:break-word;">
                        <div style="font-family:sans-serif;font-size:13px;line-height:20px;text-align:center;color:#6f7d8a;"><strong>IMAX DURANGO</strong><br></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
